...
class WinGame_menu:
    ...
    def button_setup (self):
        ...
        self.gameOver = self.gameOver_font.render('YOU WIN !!! ', True, 'white')
        self.gameOver_rect = self.gameOver.get_rect(center=(WINDOW_WIDTH // 2, 135))
    def update(self):
        self.display.blit(self.blurred, (0, 0))
        self.overlay.fill((0, 135, 0, 100))
